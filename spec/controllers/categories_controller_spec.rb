...
describe CategoriesController do
  Given(:current_user) { User.make(name: "User", email: "user@personography.com", password: "asdf", password_confirmation: 'asdf').tap { |r| r.save! } }
  Given { session[:current_user_id] =  current_user.id }
